        ...
        chartAPI('waterfall2d', {
            ...
            point: function(chartName, series, data, FCChartObj, HCObj) {
                ...
                for (index = 0, countPoint = 0; index < length; index += 1) {
                    ...
                    axisGridManager.addXaxisCat(xAxisObj, catIndex, catIndex, dataLabel, dataObj, {}, FCChartObj);
                    catIndex += 1;
                    ...
                    for (index = 0; index < dataLength; index += 1) {
                        ...
                        if (dataObj && !dataObj.vline) {
                            ...
                            series.data.push({
                                ...
                                displayValue: parseUnsafeString(pluck(dataObj.displayvalue,
                                    dataObj.valuetext, BLANK)),
            ...
            postSeriesAddition: function(HCObj, FCObj) {
                ...
                if (hcData && hcData.length) {
                        ...
                        if (index && (dataObj = hcData[index])) {
                            ...
                            if (isShift) {
                                ...
                                axisGridManager.addXaxisCat(xAxisObj, shiftCounter - 1,
                                    shiftCounter - 1, dataLabel, fcDataObj, {}, FCChartObj);
                    ...
                    axisGridManager.addXaxisCat(xAxisObj, shiftCounter,
                        shiftCounter, dataLabel, lastFcDataObj, {}, FCChartObj);
                ...
                for (index = 0; index < catLength; index += 1) {
                    ...
                    if ((dataObj = data && data[index])) {
                        if (dataObj.value) {
                            ...
                            q1 = NumberFormatter.getCleanValue(dataObj.q1);
                            q3 = NumberFormatter.getCleanValue(dataObj.q3);
                            min = lowValue = NumberFormatter.getCleanValue(dataObj.min);
                            max = NumberFormatter.getCleanValue(dataObj.max);
                            medianValue = NumberFormatter.getCleanValue(dataObj.median);
                            // get the valid value
                            highValue = itemValue = max;

                            mean = showMean = NumberFormatter.getCleanValue(dataObj.mean);
                            md = NumberFormatter.getCleanValue(dataObj.md);
                            sd = NumberFormatter.getCleanValue(dataObj.sd);
                            qd = NumberFormatter.getCleanValue(dataObj.qd);
                        }
                    }
        ...
        chartAPI('heatmap', {
            ...
            configureAxis: function(HCObj, FCObj) {
                ...
                for (i in columnIdObj) {
                    ...
                    axisGridManager.addXaxisCat(xAxis, value, 1, text, columnObj, {}, FCChartObj);
                    value -= POINT_FIVE;
                    if (value < xMax) {
                        //add lines
        ...
        renderer('renderer.heatmap', {
            drawPlotHeatmap: function(plot, dataOptions) {
                ...
                for (i = 0, ii = data.length; i < ii; i++) {
                    ...
                    if (y !== null) {
                        ...
                        for (j = 0, jj = valEles.length; j < jj; j++) {
                            !plotItems[i].dataLabels && (plotItems[i].dataLabels = []);
                            valEles[j] && datasetGraphics.push(valEles[j]);
                            plotItems[i].dataLabels.push(valEles[j]);
                        }
                    }
                    chart.drawTracker &&
            ...
            drawLabelHeatmap: function(plot, dataOptions, i) {
                ...
                if (isTLLabel) {
                    ...
                    xPos = pointX;
                    if (!tlLabelEle) {
                        tlLabelEle = plotItem.tlLabel = paper.text(dataLabelsLayer);
                    }
                    tlLabelEle.attr({
                        text: displayValue,
                        title: (smartTextObj.tooltext || ''),
                ...
                if (isTRLabel) {
                    ...
                    xPos = pointX + pointW;
                    if (!trLabelEle) {
                        trLabelEle = plotItem.trLabel = paper.text(dataLabelsLayer);
                    }
                    trLabelEle.attr({
                        text: displayValue,
                        title: (smartTextObj.tooltext || ''),
                ...
                if (isBLLabel) {
                    ...
                    xPos = pointX;
                    if (!blLabelEle) {
                        blLabelEle = plotItem.blLabel = paper.text(dataLabelsLayer);
                    }
                    blLabelEle.attr({
                        text: displayValue,
                        title: (smartTextObj.tooltext || ''),
                ...
                if (isBRLabel) {
                    ...
                    if (!brLabelEle) {
                        brLabelEle = plotItem.brLabel = paper.text(dataLabelsLayer);
                    }
                    brLabelEle.attr({
                        text: displayValue,
                        title: (smartTextObj.tooltext || ''),
