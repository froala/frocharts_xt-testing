	...
	gen.prototype = {
		...
		getRandomColor: function() {
			return '#'+Math.floor(Math.random()*16777215).toString(16);
                ...
                /*
                 * Returns random label display
                 */
                getRandomLabelDisplay: function () {
                    var labelDisplays = ['AUTO', 'WRAP', 'STAGGER', 'ROTATE', 'NONE'],
                    randomIndex = Math.floor( (Math.random()*10) % 5);
                    return [labelDisplays[randomIndex]];
                },
					...
					attrNames.forEach(function(attrName, index) {
						...
						switch(type.toLowerCase()) {
							...
							case 'number' :
								...
								break;
							case 'labeldisplay':
                                                                values = generator.getRandomLabelDisplay();
                                                                break;
                                                        default:
