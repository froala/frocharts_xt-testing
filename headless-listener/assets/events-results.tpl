	...
	<body style="font-family:sans-serif;">
		<div style="margin: 0 auto;width:900px;">
			<header>
				...
				Events Testing Results</span</div>
			</header>
			<div style="">
				...
				<div style="margin:5px;">
					<div style="display:inline-block; float:left; margin:5px ;">
						...
						<br/>
						<span  style="ffont-weight:bold;font-size:30px;"><%= total %></span>
					</div>
					...
					<% for (var key in details) { %>
					    ...
					    <tr>
							...
							<td>
								...
								<br/>
								<span style="font-weight:bold;padding:5px;"><%= detail.total %></span>
							</td>
							<td>
								<span style="font-size:14px;color:#666;">Passing</span>
								<br/>
								<span  style="font-weight:bold;color:#7cc576;padding:5px;"><%= detail.passing %></span>
							</td>
							<td>
								<span style="font-size:14px;color:#666;">Failing</span>
								<br/>
								<span style="font-weight:bold;color:#c57676;padding:5px;"><%= detail.failing %></span>
							</td>
						</tr>
					 <% } %>
				</table>
