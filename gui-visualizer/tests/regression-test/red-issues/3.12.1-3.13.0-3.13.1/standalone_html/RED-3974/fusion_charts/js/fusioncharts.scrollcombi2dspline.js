...
return webpackJsonpFusionCharts([10],{
...
var _fusioncharts = __webpack_require__(917);
...
_fusioncharts4['default'].addFile('fusioncharts.scrollcombi2dspline.js');
...
var _fusioncharts = __webpack_require__(336);
...
var UNDEFINED;
/**
 * class definition of ScrollCombi2DSpline chart API
 */

var ScrollCombi2DSpline = function (_ScrollCombi2D) {
  _inherits(ScrollCombi2DSpline, _ScrollCombi2D);

  /**
   * Constructor fn of ScrollCombi2D class
   */
  function ScrollCombi2DSpline() {
    _classCallCheck(this, ScrollCombi2DSpline);

    var _this = _possibleConstructorReturn(this, _ScrollCombi2D.call(this));
  ...
  ScrollCombi2DSpline.prototype.getName = function getName() {
    return 'ScrollCombi2DSpline';
  };
  /**
   * Sets default configuration
   * @memberof ScrollCombi2DSpline
   */


  ScrollCombi2DSpline.prototype.__setDefaultConfig = function __setDefaultConfig() {
    _ScrollCombi2D.prototype.__setDefaultConfig && _ScrollCombi2D.prototype.__setDefaultConfig.call(this);
    var config = this.config;
    if (!config) {
      config = this.config = {};
    }
    config.friendlyName = 'Scrollable Combination Spline Chart';
  ...
  ScrollCombi2DSpline.getName = function getName() {
    return 'ScrollCombi2DSpline';
  };
  /**
  ...
  ScrollCombi2DSpline.prototype.getDSdef = function getDSdef(name) {
  ...
  ScrollCombi2DSpline.prototype.getDSGroupdef = function getDSGroupdef(name) {
  ...
  ScrollCombi2DSpline.prototype.getDSType = function getDSType(name) {
...
exports['default'] = ScrollCombi2DSpline;

/***/ })

},[916])["default"];
});
//# sourceMappingURL=fusioncharts.scrollcombi2dspline.js.map